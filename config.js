...
const defaultOwner = '923046698972';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '923046698972';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'Burhan-md';
global.pairingNumber = process.env.BOT_NUMBER || '923046698972';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'vVoFBJYJ#nswIZQX-Tmxcy1u2nFuIXRE2v-QPTA8TQFe-zEayg9s';  // put your session id here
